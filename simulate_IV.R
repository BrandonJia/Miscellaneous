...
# We will first simulate our treatment variable, endogenous portion of x and its confounder, c
...
# by the way, if you are curious about syntax for mvnorm... ??MASS::mvnorm
...
# I'm not getting into how standard errors (or Betas for that matter) are actually calculated computationally in this
# course (I assume you got that in your intro to stats class), but you can look up why this happens on Stack Overflow if you are curious.
