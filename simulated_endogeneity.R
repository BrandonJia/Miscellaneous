...
## Some examples of what happens when we ignore different kinds of measurement error...
...
# You can see that ignoring Z causes X to be downward bias (because Z is negatively correlated with X)
summary(lm(Y~X))
summary(lm(Y~X+Z))
